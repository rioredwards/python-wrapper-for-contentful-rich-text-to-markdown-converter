// node-contentful-rich-text-to-markdown-converter/dist/bundle.mjs
...
var require_main = __commonJS({
  "node_modules/node-html-markdown/dist/main.js"(exports) {
    ...
    var NodeHtmlMarkdown2 = class _NodeHtmlMarkdown {
...
var import_rich_text_html_renderer = __toESM(require_rich_text_html_renderer_es5(), 1);
var import_node_html_markdown = __toESM(require_dist2(), 1);
function convertRichTextToMarkdown(document2) {
  const html = (0, import_rich_text_html_renderer.documentToHtmlString)(document2);
  const markdown = import_node_html_markdown.NodeHtmlMarkdown.translate(html);
  return markdown;
}

// adapter.mjs
var rawRichText = process.argv[2];
if (!rawRichText || typeof rawRichText !== "string") {
  console.error("Please provide a rich text entry as an argument.");
  process.exit(1);
}
function main() {
  const document2 = JSON.parse(rawRichText);
  const result = convertRichTextToMarkdown(document2);
  if (result === void 0) {
